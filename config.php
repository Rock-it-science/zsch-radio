...
$XPWD = 'test';	// The password set in RadioDJ Now Playing Info plugin Web Export options

$album_art_PATH = '../album_art/';					// Change this to the PATH of album art

$album_art_URL = '/album_art/';					// Change this to the URL or location of album art
